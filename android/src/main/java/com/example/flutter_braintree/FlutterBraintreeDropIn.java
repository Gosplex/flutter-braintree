...
public class FlutterBraintreeDropIn implements FlutterPlugin, ActivityAware, MethodCallHandler, ActivityResultListener, Serializable {
    ...
    // This static function is for backward compatibility with pre-Flutter 1.12 projects
    ...
    public void onMethodCall(MethodCall call, Result result) {
        if (call.method.equals("start")) {
            if (activity == null) {
                result.error("no_activity", "Drop-in requires a foreground activity", null);
                return;
            }
                ...
                if (resultCode == Activity.RESULT_OK) {
                    if (data != null) {
                        ...
                        if (dropInResult != null) {
                            ...
                            activeResult.error("invalid_result", "Drop-in result was null", null);
                        }
                    } else {
                        activeResult.error("invalid_result", "Drop-in data was null", null);
                    }
